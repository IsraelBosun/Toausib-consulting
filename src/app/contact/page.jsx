                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-warm-gray text-sm">{companyInfo.address}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-warm-gray text-sm">{companyInfo.phone}</p>
                    </div>
                  </div>
      ...
      <section className="h-96 bg-gray-200 relative">
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-xl font-serif text-navy mb-2">Our Office Location</p>
            <p className="text-warm-gray">{companyInfo.address}</p>
            <button className="mt-4 px-6 py-2 bg-navy text-white hover:bg-gold transition-colors duration-300">
              Open in Maps
            </button>
          </div>
        </div>
